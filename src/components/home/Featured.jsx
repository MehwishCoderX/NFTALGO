  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto p-32">
      ...
      <h2 className="text-gray-400 text-lg text-center mb-6 font-[Roboto]">
        Explore our exclusive featured collection, showcasing innovative campaigns
        and creative storytelling from top brands around the world.
      </h2>
      ...
      >
        {nftData.map((nft) => (
          <div
            key={nft.id}
            className="card-container p-4 flex flex-col gap-1"
            style={{ width: "308px", height: "411px" }}
          >
            {/* Profile Section */}
            ...
            {/* Buy Section */}
            <div className="flex justify-between gap-2 items-center font-[Roboto]">
              ...
              <div className="bg-white p-1 rounded-lg shadow-sm flex items-center">
                ...
                />
                <span className="ml-1 text-black  font-[12px]">{nft.price}</span>
              </div>
            </div>
          </div>
        ))}
