...
export default function NFTCarousel() {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-16">
      {/* Section Title */}
        ...
        {nftData.map((nft) => (
          ...
          >
            ...
            <div className="flex justify-between items-center font-[Roboto]">
              <button className="bg-red-500 text-white px-4 py-1 rounded-md text-sm">Buy</button>
