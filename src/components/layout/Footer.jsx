...
//         <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-around items-center text-center md:text-left">
          
         
//           <div className="-ml-72 mb-16 "> <img src={FooterLogo} alt="Fry Networks" className="pr-8 md:w-40" /></div>
    ...
    <>
      ...
      <div className=" md:mb-0">
        ...
        <div className="gap-20 max-w-6xl mx-auto flex flex-col md:flex-row justify-around items-center text-center md:text-left">
          ...
          <div className=" -ml-24 mb-16 "> <img src={FooterLogo} alt="Fry Networks" className="pr-8 md:w-40" /></div>
